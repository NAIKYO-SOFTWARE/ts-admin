                    ...
                    <TabPane tabId={1}>
                      <Form>
                        <Row>
                          <Col lg='6'>
                            <FormGroup className='mb-3'>
                              <Label htmlFor='basicpill-firstname-input12'>First name</Label>
                              <Input
                                type='text'
                                className='form-control'
                          ...
                          <Col lg='6'>
                            <FormGroup className='mb-3'>
                              <Label htmlFor='basicpill-lastname-input22'>Last name</Label>
                              <Input
                                type='text'
                                className='form-control'
                        ...
                        <Row>
                          <Col lg='6'>
                            <FormGroup className='mb-3'>
                              <Label htmlFor='basicpill-phoneno-input32'>Phone</Label>
                              <Input
                                type='text'
                                className='form-control'
                          ...
                          <Col lg='6'>
                            <FormGroup className='mb-3'>
                              <Label htmlFor='basicpill-email-input42'>Email</Label>
                              <Input
                                type='email'
                                className='form-control'
                        ...
                        <Row>
                          <Col lg='12'>
                            <FormGroup className='mb-3'>
                              <Label htmlFor='basicpill-address-input12'>Address</Label>
                              <textarea
                      ...
                      <div>
                        <Form>
                          <Row>
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-pancard-input52'>PAN Card</Label>
                                <Input
                                  type='text'
                                  className='form-control'
                            ...
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-vatno-input62'>VAT/TIN No.</Label>
                                <Input
                                  type='text'
                                  className='form-control'
                          ...
                          <Row>
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-cstno-input72'>CST No.</Label>
                                <Input
                                  type='text'
                                  className='form-control'
                            ...
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-servicetax-input82'>Service Tax No.</Label>
                                <Input
                                  type='text'
                                  className='form-control'
                          ...
                          <Row>
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-companyuin-input92'>Company UIN</Label>
                                <Input
                                  type='text'
                                  className='form-control'
                            ...
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-declaration-input102'>Declaration</Label>
                                <Input
                                  type='text'
                                  className='form-control'
                      ...
                      <div>
                        <Form>
                          <Row>
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-namecard-input112'>Name on Card</Label>
                                <Input
                                  type='text'
                                  className='form-control'
                          ...
                          <Row>
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-cardno-input122'>Credit Card Number</Label>
                                <Input
                                  type='text'
                                  className='form-control'
                          ...
                          <Row>
                            <Col lg='6'>
                              <FormGroup className='mb-3'>
                                <Label htmlFor='basicpill-expiration-input132'>Expiration Date</Label>
                                <Input
                                  type='text'
                                  className='form-control'
